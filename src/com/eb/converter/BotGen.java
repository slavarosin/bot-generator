...
public class BotGen {
	...
	private final static String[] nicknamesLT = new String[] {
			...
			"mashka-kakashka", "indrucka2220", "ana2", "garfildazz",
			"Liebe", "Akage (a.k.a. Hi no tori)", "itaurus", "Hellen",
			"Роял-Драйв", "Veta-konfeta", "Ostap_Bender", "~Луна Лавгуд~",
			"Spoller", "Sataniolla_Milton", "Forlink", "Skvoal", "CrazyFeSS",
			"Elio", "Alik", "Niari", "Iriya", "ArchiFuck", "near", "марусишка",
	...
	public static void main(String[] args) {
		File f = new File("botlist.txt");
		File f2 = new File("botlist2.txt");

		System.out.println(nicknamesEE.length);
		System.out.println(nicknamesLV.length);
		System.out.println(nicknamesLT.length);
